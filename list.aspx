...
<script runat="server" language="vb">
	...
	if homepage = 1 then
		  'set all to 0 '
	  	  ...
	  	  Dim iConn As New OleDbConnection("PROVIDER=Microsoft.Jet.OLEDB.4.0;DATA SOURCE="/App_Data/acm2000.mdb"")
		 ...
		 'set homepage '
	  	  ...
	  	  Dim iConn2 As New OleDbConnection("PROVIDER=Microsoft.Jet.OLEDB.4.0;DATA SOURCE="/App_Data/acm2000.mdb"")
	...
	if deleteid > 0 then
	      Dim queryvalue = Request.QueryString("deleteid")
	  	  ...
	  	  Dim dconn As New OleDbConnection("PROVIDER=Microsoft.Jet.OLEDB.4.0;DATA SOURCE="/App_Data/acm2000.mdb"")
