...
function register()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=register1" method="post">
...
function register1($uce, $upe, $upa, $utosflag)
{
	...
	if($r=mysql_query($q))
	{
		...
		$confurl = $baseurl . "index.html?a=confirm&mid=".mysql_insert_id()."&cbcode=".$cbcode;
		$msg = <<<TXT
THIS IS NOT SPAM
----------------
...
function login()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=login1" method="post">
		...
		<p><a href="index.html?a=retpass">Forgot password? Retrieve it here.</a></p>
HTM;
...
function login1($pu, $pp)
{
	...
	if($r=mysql_query($q))
	{
		...
		if($pp == $cbpass)
		{
			...
			header("Location: index.html?a=mem");
		}
		else
		{
...
function getMemMenu()
{
	...
	{
		$storeurl = $baseurl . "store.html?mem_id=$usid";
	}
	
	$codetoreturn .= <<<HTM
		<p align="center"><b>Hello $uname</b> (<a href="index.html?a=logoff">Logoff</a> - <a href="index.html?a=changepwd">Change Password</a>)</p>
		...
		<table border="1" cellpadding="2" cellspacing="0" align="center">
			...
			<tr>
				<td align="center">
					<a href="index.html?a=chooseTemplate">Choose store template</a>
				</td>
			</tr>
			<tr>

				<td align="center">
					<a href="index.html?a=showBasic">Maintain basic information</a>
				</td>
			</tr>
			<tr>
				<td align="center">
					<a href="index.html?a=showPay">Maintain payment processing information</a>
				</td>
			</tr>
			<tr>
				<td align="center">
					<a href="index.html?a=showInv">Maintain store inventory (add/remove items)</a>
				</td>
			</tr>
			<tr>
				<td align="center">
					<a href="index.html?a=addThankyou">Add thank you note</a>
				</td>
			</tr>
		</table>
...
function retpass()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=retpass1" method="post">
...
function changepwd()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=changepwd1" method="post">
...
HTM;
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=saveTemplate" method="post">
...
function showBasic()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=saveBasic" method="post">
...
function showPay()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=savePay" method="post">
		...
		<table border="1" cellpadding="2" cellspacing="0" align="center">
			...
			<tr>
				<td align="center" valign="top">
					...
					<a href="index.html?a=addCat">Add new category</a>
					<form action="index.html?a=delCat" method="post">
						Select category: 
				...
				<td align="center" valign="top">
					...
					<form action="index.html?a=addItem" method="post">
						Select category: 
						<select name="storecat2" size="1">$dropdown</select>
						<input type="submit" value="Add new item">
					</form>
					<form action="index.html?a=editItem" method="post">
						Select item: 
						<select name="storeitem1" size="1">$dropdown2</select>
						<input type="submit" value="Edit Item">
					</form>
					<form action="index.html?a=delItem" method="post">
						Select item: 
...
function addCat()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=saveCat" method="post">
...
function delCat($ca)
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=delCat1" method="post">
...
function addItem($storecat2, $itmid)
{
	...
	if($storecat2)
	{
  	...
  	$pagecontent .= <<<HTM
  		...
  		<form action="index.html?a=saveItem" method="post">
...
function delItem($itemID1)
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=delItem1" method="post">
...
function addThankyou()
{
	...
	$pagecontent .= <<<HTM
		...
		<form action="index.html?a=saveThankyou" method="post">
